/**
* @file parsing.h
* @brief This header file contains all the functions that use for parse text.
*/
...
/**
* This method convert a inventory structure to string
* at format inv.name\tinv.quantity
* @param inv The inventory to convert
* @param toString The string that will get the value 
*/
...
* @param inv The array inventory that will set the value
*/
void decodeClientRequest(char* request, inventory* inv)
{
	char* temp;
...
* @param server_inventory The server's starting inventory
